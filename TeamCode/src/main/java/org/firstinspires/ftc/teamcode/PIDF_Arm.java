...
public class PIDF_Arm extends OpMode {
    ...
    public void init() {
        ...
        arm_motor.setMode(DcMotorEx.RunMode.STOP_AND_RESET_ENCODER); // Reset the motor encoder
        arm_motor.setMode(DcMotorEx.RunMode.RUN_WITHOUT_ENCODER); // Turn the motor back on when we are done
